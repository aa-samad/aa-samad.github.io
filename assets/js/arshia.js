...
function pagePilling(){
    ...
    $('#pagepiling').pagepiling({
        ...
        onLeave: function(index, nextIndex, direction){
            ...
            if(nextIndex==1)
            {
                $(".special-section").css('color', '#fafafa');
                $("#pp-nav").css('color', '#fafafa');
            }
            else
            {
                $(".special-section").css('color', '#3c3c3c');
                $("#pp-nav").css('color', '#3c3c3c');
            }

            if(nextIndex==1 &&  $('.section.hero').hasClass("speacial-hero")) {
                $("#pp-nav li span").css('backgroundColor', '#fafafa');
            }else{
                $("#pp-nav li span").css('backgroundColor', '#3c3c3c');
            }
        
            if(nextIndex==1 &&  $('.section.hero').hasClass("speacial-hero")) {
                $("#pp-nav li .pp-tooltip").css('color', '#fafafa');
            }else{
